  ...
  a.dispatchEvent = function(a, b) {
    ...
    if(a && f) {
      ...
      for(var f = f.slice(), e = 0, c = f.length;e < c;e++) {
        var h = f[e];
        h instanceof Function ? g = g || h.apply(null, [a]) : h.handleEvent && (g = g || h.handleEvent(a))
      }
    }
    return!!g
  };
  ...
  a._sendProgress = function(a) {
    if(!this._isCanceled()) {
      ...
      if(typeof a == "number") {
        ...
        if(b = a, this.progress = a.loaded / a.total, isNaN(this.progress) || this.progress == Infinity) {
          this.progress = 0
        }
      }
      b.target = this;
...
(function() {
  ...
  a.remove = function(b) {
    ...
    if(a) {
      for(;a.length;) {
        for(var d = a.pop(), e = this.getResult(d), c = this._loadQueue.length - 1;c >= 0;c--) {
          if(h = this._loadQueue[c].getItem(), h.id == d || h.src == d) {
            this._loadQueue.splice(c, 1)[0].cancel();
            break
          }
        }
        for(c = this._loadQueueBackup.length - 1;c >= 0;c--) {
          if(h = this._loadQueueBackup[c].getItem(), h.id == d || h.src == d) {
      ...
      this.close();
      for(d in this._loadItemsById) {
        this._disposeItem(this._loadItemsById[d])
      }
  ...
  a.installPlugin = function(b) {
    if(!(b == null || b.getPreloadHandlers == null)) {
      ...
      if(b.types != null) {
        for(var a = 0, d = b.types.length;a < d;a++) {
          this._typeCallbacks[b.types[a]] = b.callback
        }
      }
      if(b.extensions != null) {
        for(a = 0, d = b.extensions.length;a < d;a++) {
  ...
  a.loadFile = function(b, a) {
    b == null ? this._sendError({text:"PRELOAD_NO_FILE"}) : (this._addItem(b), a !== false && this.setPaused(false))
  };
  ...
  a._addItem = function(b) {
    ...
    if(b != null) {
      ...
      a != null && (this._loadQueue.push(a), this._loadQueueBackup.push(a), this._numItems++, this._updateProgress(), this.maintainScriptOrder && b.type == createjs.LoadQueue.JAVASCRIPT && a instanceof createjs.XHRLoader && (this._scriptOrder.push(b), this._loadedScripts.push(null)))
    }
  };
  a._createLoadItem = function(b) {
    ...
    switch(typeof b) {
      case "string":
        ...
        break;
      case "object":
        a = window.HTMLAudioElement && b instanceof HTMLAudioElement ? {tag:b, src:a.tag.src, type:createjs.LoadQueue.SOUND} : b
    }
    ...
    if(a.type == null) {
      a.type = this._getTypeByExtension(a.ext)
    }
    if(a.tag == null) {
      a.tag = this._createTag(a.type)
    }
    if(a.id == null || a.id == "") {
      a.id = a.src
    }
    if(b = this._typeCallbacks[a.type] || this._extensionCallbacks[a.ext]) {
      ...
      if(b === false) {
        ...
        if(b !== true) {
          ...
          if(b.tag != null && b.tag.load instanceof Function) {
            a.tag = b.tag
          }
          if(b.completeHandler != null) {
  ...
  a._removeLoadItem = function(a) {
    for(var d = this._currentLoads.length, c = 0;c < d;c++) {
  ...
  a._updateProgress = function() {
    var a = this._numItemsLoaded / this._numItems, d = this._numItems - this._numItemsLoaded;
    if(d > 0) {
      for(var c = 0, e = 0, o = this._currentLoads.length;e < o;e++) {
  ...
  a._createTag = function(a) {
    ...
    switch(a) {
      ...
      case createjs.LoadQueue.CSS:
        return d = this.useXHR ? document.createElement("style") : document.createElement("link"), d.rel = "stylesheet", d.type = "text/css", d;
  ...
  a._sendFileProgress = function(a, d) {
    if(this._isCanceled()) {
      ...
      var c = {target:this, type:"fileprogress", progress:d, loaded:d, total:1, item:a};
  ...
  a._sendFileComplete = function(a) {
    if(!this._isCanceled()) {
      var d = {target:this, type:"fileload", item:a, result:this._loadedResults[a.id], rawResult:this._loadedRawResults[a.id]};
...
(function() {
  ...
  a.load = function() {
    ...
    if(a.type == createjs.LoadQueue.SVG || a.type == createjs.LoadQueue.JAVASCRIPT || a.type == createjs.LoadQueue.CSS) {
  ...
  a._handleLoad = function() {
    if(!this._isCanceled()) {
      ...
      if(!(this.loaded || this.isAudio && b.readyState !== 4)) {
        this.loaded = true, a.type == createjs.LoadQueue.SVG && (document.body || document.getElementsByTagName("body")[0]).removeChild(b), this._clean(), this._sendComplete()
      }
    }
  };
  a._clean = function() {
...
(function() {
    ...
    switch(typeof j) {
      ...
      case "object":
        ...
        if(h && typeof h === "object") {
          p = h.length;
          for(g = 0;g < p;g += 1) {
            typeof h[g] === "string" && (n = h[g], (m = d(n, j)) && k.push(a(n) + (f ? ": " : ":") + m))
          }
        }else {
          for(n in j) {
            Object.prototype.hasOwnProperty.call(j, n) && (m = d(n, j)) && k.push(a(n) + (f ? ": " : ":") + m)
          }
        }
        m = k.length === 0 ? "{}" : f ? "{\n" + f + k.join(",\n" + f) + "\n" + q + "}" : "{" + k.join(",") + "}";
        f = q;
  ...
  var b = /[\u0000\u00ad\u0600-\u0604\u070f\u17b4\u17b5\u200c-\u200f\u2028-\u202f\u2060-\u206f\ufeff\ufff0-\uffff]/g, g = /[\\\"\x00-\x1f\x7f-\x9f\u00ad\u0600-\u0604\u070f\u17b4\u17b5\u200c-\u200f\u2028-\u202f\u2060-\u206f\ufeff\ufff0-\uffff]/g, f, e, o = {"\u0008":"\\b", "\t":"\\t", "\n":"\\n", "\u000c":"\\f", "\r":"\\r", '"':'\\"', "\\":"\\\\"}, h;
    ...
    JSON.parse = function(a, c) {
      function d(a, b) {
        ...
        if(f && typeof f === "object") {
          for(e in f) {
            Object.prototype.hasOwnProperty.call(f, e) && (g = d(f, e), g !== void 0 ? f[e] = g : delete f[e])
          }
        }
        return c.call(a, b, f)
      }
...
(function() {
  ...
  a.initialize = function(a) {
    ...
    a.removeAllEventListeners = d.removeAllEventListeners;
    a.hasEventListener = d.hasEventListener;
  ...
  d.addEventListener = function(a, c) {
    var b = this._listeners;
    b ? this.removeEventListener(a, c) : b = this._listeners = {};
    var e = b[a];
    e || (e = b[a] = []);
    e.push(c);
    return c
  ...
  d.removeAllEventListeners = function(a) {
    a ? this._listeners && delete this._listeners[a] : this._listeners = null
  };
  d.dispatchEvent = function(a, c) {
    var b = !1, e = this._listeners;
    if(a && e) {
      ...
      for(var e = e.slice(), k = 0, f = e.length;k < f;k++) {
        var g = e[k];
        g instanceof Function ? b = b || g.apply(null, [a]) : g.handleEvent && (b = b || g.handleEvent(a))
      }
    }
    return!!b
  };
  d.hasEventListener = function(a) {
...
(function() {
  ...
  a.sendLoadComplete = function(b) {
    if(a.preloadHash[b]) {
      for(var e = 0, c = a.preloadHash[b].length;e < c;e++) {
        var f = a.preloadHash[b][e], f = {target:this, type:"loadComplete", src:f.src, id:f.id, data:f.data};
        a.preloadHash[b][e] = !0;
        a.onLoadComplete && a.onLoadComplete(f);
        a.dispatchEvent(f)
      }
    }
  };
  ...
  a.registerPlugin = function(b) {
    ...
    return null == b ? !1 : b.isSupported() ? (a.activePlugin = new b, !0) : !1
  };
  a.registerPlugins = function(b) {
    for(var e = 0, c = b.length;e < c;e++) {
      if(a.registerPlugin(b[e])) {
        return!0
      }
    }
    return!1
  ...
  a.getCapability = function(b) {
    return null == a.activePlugin ? null : a.activePlugin.capabilities[b]
  };
  a.initLoad = function(b, e, c, f) {
    b = a.registerSound(b, c, f, !1);
    return null == b ? !1 : b
  };
  a.registerSound = function(b, e, c, f) {
    if(!a.initializeDefaultPlugins()) {
      return!1
    }
    b instanceof Object && (b = b.src, e = b.id, c = b.data);
    var g = a.parsePath(b, "sound", e, c);
    if(null == g) {
      return!1
    }
    null != e && (a.idHash[e] = g.src);
    var j = null;
    null != c && (isNaN(c.channels) ? isNaN(c) || (j = parseInt(c)) : j = parseInt(c.channels));
    var h = a.activePlugin.register(g.src, j);
    null != h && (null != h.numChannels && (j = h.numChannels), d.create(g.src, j), null == c || !isNaN(c) ? c = g.data = j || d.maxPerChannel() : c.channels = g.data.channels = j || d.maxPerChannel(), null != h.tag ? g.tag = h.tag : h.src && (g.src = h.src), null != h.completeHandler && (g.completeHandler = h.completeHandler), g.type = h.type);
    !1 != f && (a.preloadHash[g.src] || (a.preloadHash[g.src] = []), a.preloadHash[g.src].push({src:b, id:e, data:c}), 1 == a.preloadHash[g.src].length && a.activePlugin.preload(g.src, h));
    return g
  };
  a.registerManifest = function(b) {
    for(var a = [], c = 0, f = b.length;c < f;c++) {
      a[c] = createjs.Sound.registerSound(b[c].src, b[c].id, b[c].data, b[c].preload)
    }
    return a
  };
  a.loadComplete = function(b) {
    var e = a.parsePath(b, "sound");
    b = e ? a.getSrcById(e.src) : a.getSrcById(b);
    return!0 == a.preloadHash[b][0]
  };
  a.parsePath = function(b, e, c, f) {
    "string" != typeof b && (b = b.toString());
    b = b.split(a.DELIMITER);
    e = {type:e || "sound", id:c, data:f};
    c = a.getCapabilities();
    f = 0;
    for(var g = b.length;f < g;f++) {
      var d = b[f], h = d.match(a.FILE_PATTERN);
      if(null == h) {
        return!1
      }
      var l = h[4], h = h[5];
      if(c[h] && -1 < a.SUPPORTED_EXTENSIONS.indexOf(h)) {
        return e.name = l, e.src = d, e.extension = h, e
      }
    }
    return null
  };
  a.play = function(b, e, c, f, g, d, h) {
    b = a.createInstance(b);
    a.playInstance(b, e, c, f, g, d, h) || b.playFailed();
    return b
  };
  a.createInstance = function(b) {
    ...
    var e = a.parsePath(b, "sound");
    b = e ? a.getSrcById(e.src) : a.getSrcById(b);
    var e = b.lastIndexOf("."), c = b.slice(e + 1);
    -1 != e && -1 < a.SUPPORTED_EXTENSIONS.indexOf(c) ? (d.create(b), b = a.activePlugin.create(b)) : b = a.defaultSoundInstance;
    b.uniqueId = a.lastId++;
    return b
  };
  a.setVolume = function(b) {
    ...
    a.masterVolume = b;
    if(!this.activePlugin || !this.activePlugin.setVolume || !this.activePlugin.setVolume(b)) {
      for(var e = this.instances, c = 0, f = e.length;c < f;c++) {
        e[c].setMasterVolume(b)
      }
    }
  };
  ...
  a.mute = function(b) {
    this.masterMute = b;
    if(!this.activePlugin || !this.activePlugin.setMute || !this.activePlugin.setMute(b)) {
      for(var a = this.instances, c = 0, f = a.length;c < f;c++) {
        a[c].setMasterMute(b)
      }
    }
  };
  ...
  a.stop = function() {
    for(var b = this.instances, a = b.length;0 < a;a--) {
      b[a - 1].stop()
    }
  };
  a.playInstance = function(b, c, k, f, g, d, h) {
    c = c || a.defaultInterruptBehavior;
    null == k && (k = 0);
    null == f && (f = b.getPosition());
    null == g && (g = 0);
    null == d && (d = b.getVolume());
    null == h && (h = b.getPan());
    if(0 == k) {
      if(!a.beginPlaying(b, c, f, g, d, h)) {
        return!1
      }
    }else {
      k = setTimeout(function() {
        a.beginPlaying(b, c, f, g, d, h)
      }, k), b.delayTimeoutId = k
    }
    this.instances.push(b);
    return!0
  };
  a.beginPlaying = function(b, a, c, f, g, j) {
    return!d.add(b, a) ? !1 : !b.beginPlaying(c, f, g, j) ? (b = this.instances.indexOf(b), -1 < b && this.instances.splice(b, 1), !1) : !0
  };
  a.getSrcById = function(b) {
    return null == a.idHash || null == a.idHash[b] ? b : a.idHash[b]
  };
  a.playFinished = function(b) {
    d.remove(b);
    b = this.instances.indexOf(b);
    -1 < b && this.instances.splice(b, 1)
  };
  a.proxy = function(b, a) {
    return function() {
  ...
  d.create = function(b, a) {
    return null == d.get(b) ? (d.channels[b] = new d(b, a), !0) : !1
  };
  d.add = function(b, a) {
    var c = d.get(b.src);
    return null == c ? !1 : c.add(b, a)
  };
  d.remove = function(b) {
    var a = d.get(b.src);
    if(null == a) {
  ...
  d.maxPerChannel = function() {
    return c.maxDefault
  };
  d.get = function(b) {
    return d.channels[b]
  };
  var c = d.prototype = {src:null, max:null, maxDefault:100, length:0, init:function(b, a) {
    this.src = b;
    this.max = a || this.maxDefault;
    ...
    for(var c, d, f = 0, g = this.max;f < g;f++) {
      ...
      if(!(b == a.INTERRUPT_NONE && c.playState != a.PLAY_FINISHED)) {
        if(0 == f) {
          d = c
        }else {
          if(c.playState == a.PLAY_FINISHED || c == a.PLAY_INTERRUPTED || c == a.PLAY_FAILED) {
            d = c
          }else {
            if(b == a.INTERRUPT_EARLY && c.getPosition() < d.getPosition() || b == a.INTERRUPT_LATE && c.getPosition() > d.getPosition()) {
              d = c
            }
          }
        }
  ...
  l.init = function() {
    ...
    l.isFirefox = -1 < b.indexOf("Firefox");
    l.isOpera = null != window.opera;
    l.isChrome = -1 < b.indexOf("Chrome");
    l.isIOS = -1 < b.indexOf("iPod") || -1 < b.indexOf("iPhone") || -1 < b.indexOf("iPad");
    l.isAndroid = -1 < b.indexOf("Android");
    l.isBlackberry = -1 < b.indexOf("Blackberry")
  };
  l.init();
  createjs.Sound.BrowserDetect = l
})();
this.createjs = this.createjs || {};
(function() {
  function a() {
  ...
  a.generateCapabilities = function() {
    if(null == a.capabilities) {
      ...
      a.capabilities = {panning:!0, volume:!0, tracks:-1};
      for(var b = createjs.Sound.SUPPORTED_EXTENSIONS, e = createjs.Sound.EXTENSION_MAP, d = 0, f = b.length;d < f;d++) {
        var g = b[d], j = e[g] || g;
        a.capabilities[g] = "no" != c.canPlayType("audio/" + g) && "" != c.canPlayType("audio/" + g) || "no" != c.canPlayType("audio/" + j) && "" != c.canPlayType("audio/" + j)
      }
  ...
  a.prototype = {capabilities:null, volume:1, context:null, dynamicsCompressorNode:null, gainNode:null, arrayBuffers:null, init:function() {
  ...
  onPlayFailed:null, onComplete:null, onLoop:null, sendEvent:function(a) {
    ...
    this.sourceNode && this.sourceNode.playbackState != this.sourceNode.UNSCHEDULED_STATE && (this.sourceNode.noteOff(0), this.sourceNode = null);
  ...
  }, play:function(a, b, e, d, f, g) {
    this.cleanUp();
    createjs.Sound.playInstance(this, a, b, e, d, f, g)
  }, beginPlaying:function(a, b, e, d) {
    ...
    if(this.owner.capabilities.panning) {
      this.panNode.setPosition(a, 0, -0.5), this.pan = a
    }else {
      return!1
    }
  }, getPan:function() {
    ...
    this.offset = a / 1E3;
    this.sourceNode && this.sourceNode.playbackState != this.sourceNode.UNSCHEDULED_STATE && (this.sourceNode.noteOff(0), clearTimeout(this.soundCompleteTimeout));
  ...
  l.prototype = {request:null, owner:null, progress:-1, src:null, result:null, onload:null, onprogress:null, onError:null, init:function(a, b) {
    this.src = a;
    this.owner = b
  }, load:function(a) {
    null != a && (this.src = a);
    ...
    a.context.decodeAudioData(this.request.response, createjs.proxy(this.handleAudioDecoded, this), createjs.proxy(this.handleError, this))
...
(function() {
  ...
  a.generateCapabilities = function() {
    if(null == a.capabilities) {
      ...
      a.capabilities = {panning:!0, volume:!0, tracks:-1};
      for(var c = createjs.Sound.SUPPORTED_EXTENSIONS, d = createjs.Sound.EXTENSION_MAP, f = 0, g = c.length;f < g;f++) {
        var j = c[f], h = d[j] || j;
        a.capabilities[j] = "no" != b.canPlayType("audio/" + j) && "" != b.canPlayType("audio/" + j) || "no" != b.canPlayType("audio/" + h) && "" != b.canPlayType("audio/" + h)
      }
    }
  };
  a.prototype = {capabilities:null, audioSources:null, defaultNumChannels:2, init:function() {
    this.capabilities = a.capabilities;
    this.audioSources = {}
  }, register:function(a, e) {
    this.audioSources[a] = !0;
    for(var d = c.get(a), f = null, g = e || this.defaultNumChannels, j = 0;j < g;j++) {
      f = this.createTag(a), d.add(f)
    }
    return{tag:f, numChannels:g}
    ...
    if(!this.isPreloadStarted(a)) {
      var e = c.get(a), k = this.createTag(a);
      e.add(k);
      this.preload(a, {tag:k})
    }
    return new d(a, this)
  }, isPreloadStarted:function(a) {
  ...
  init:function(a, c) {
  ...
  }, play:function(a, c, d, f, g, j) {
    this.cleanUp();
    createjs.Sound.playInstance(this, a, c, d, f, g, j)
  }, beginPlaying:function(a, e, d) {
    if(null == window.createjs) {
      return-1
    }
    var f = this.tag = c.getInstance(this.src);
    if(null == f) {
    ...
    null != window.createjs && (this.playState = createjs.Sound.PLAY_SUCCEEDED, this.paused = !1, this.tag.removeEventListener(createjs.HTMLAudioPlugin.AUDIO_READY, this.readyHandler, !1), this.offset >= this.getDuration() ? this.playFailed() : (0 < this.offset && (this.tag.currentTime = 0.001 * this.offset), -1 == this.remainingLoops && (this.tag.loop = !0), this.tag.play()))
  }, pause:function() {
  ...
  createjs.EventDispatcher.initialize(d.prototype);
  l.prototype = {src:null, tag:null, preloadTimer:null, loadedHandler:null, init:function(a, c) {
    this.src = a;
    this.tag = c;
  ...
  c.setInstance = function(a, d) {
    var k = c.tags[a];
    return null == k ? null : k.set(d)
  };
  c.prototype = {src:null, length:0, available:0, tags:null, init:function(a) {
    this.src = a;
    this.tags = []
  }, add:function(a) {
    this.tags.push(a);
  ...
  C.open = function(config, documentContext) {
    try {
      ...
      base.animate({width:config.width, "margin-left":-0.5 * config.width, height:config.height, "margin-top":-0.5 * config.height}, 400, "easeOutBack", function() {
        ...
        $("#spotlight .fader", documentContext).fadeOut(2E3);
